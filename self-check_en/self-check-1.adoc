...
.Question 1
****
Which of the following are valid Standard Pascal identifiers?
...
and local variables are of identical or different types is irrelevant. It’s as incorrect a pair of declarations as this would be:
